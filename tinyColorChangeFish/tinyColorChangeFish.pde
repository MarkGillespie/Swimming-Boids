...
void setup(){
  ...
  **************************************/
  ...
  size(1100, 700);//sets window dimensions: width is 1280 pixels, height is 700 pixels
...
void draw(){
  ...
  ****************************************/
  ...
  text("Number of Boids: " + school.size(), width-200, height-15);//print number of fish at the bottom right
}
